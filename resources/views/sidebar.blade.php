 ...
 <aside id="default-sidebar" class="fixed top-0 left-0 z-40 w-64 h-screen transition-transform -translate-x-full sm:translate-x-0" aria-label="Sidebar">
    <div class="h-full px-3 py-4 overflow-y-auto bg-gray-50 dark:bg-gray-800">
       <ul class="space-y-2 font-medium">
          ...
          <li>
             <a href="{{route('dashboard')}}" class="flex items-center p-2  rounded-lg   {{Request::is('dashboard') ? 'bg-blue-400' : 'hover:bg-gray-100 dark:hover:bg-gray-700'}}   group">
          ...
          <li>
             <a href="#" class="flex items-center p-2  rounded-lg  {{Request::is('utilisateur') ? 'bg-blue-400' : 'hover:bg-gray-100 dark:hover:bg-gray-700'}} group">
               <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="w-6 h-6">
         ...
         <li>
            <a href="#" class="flex items-center p-2  rounded-lg  {{Request::is('personnel') ? 'bg-blue-400' : 'hover:bg-gray-100 dark:hover:bg-gray-700'}} group">
         ...
         <li>
            <div class="flex items-center p-2  rounded-lg   group">
                  <input type="checkbox" class="light-switch" value="synthwave" />
            </div>
         </li>
       </ul>
